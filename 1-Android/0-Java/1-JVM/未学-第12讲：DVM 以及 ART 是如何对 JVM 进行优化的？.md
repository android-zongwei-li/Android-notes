...
![image.png](images/未学-第12讲：DVM 以及 ART 是如何对 JVM 进行优化的？/CgqCHl6qeUKAa86MAAY44MY5alU343.png)
...
![image (1).png](images/未学-第12讲：DVM 以及 ART 是如何对 JVM 进行优化的？/Ciqc1F6qeV-Adn0UAAEbHYFz0mQ062.png)
...
![image (2).png](images/未学-第12讲：DVM 以及 ART 是如何对 JVM 进行优化的？/Ciqc1F6qecWAQPyJAAPaD9Cc_ck785.png)
...
![image (3).png](images/未学-第12讲：DVM 以及 ART 是如何对 JVM 进行优化的？/CgqCHl6qeduARPd9AAFJZeldgmo025.png)
...
![image (4).png](images/未学-第12讲：DVM 以及 ART 是如何对 JVM 进行优化的？/CgqCHl6qeg6AfRvnAABDon1VbNU374.png)

经过编译为 Dex1.class 之后，查看其字节码为下图所示：

![image (5).png](images/未学-第12讲：DVM 以及 ART 是如何对 JVM 进行优化的？/Ciqc1F6qehmAcmWNAAB3egTLyn0886.png)

add 方法会使用 4 行指令来完成。而通过 dx 将其优化为 .dex 文件后，再次查看它的 Dalvik 字节码为如下：

![image (6).png](images/未学-第12讲：DVM 以及 ART 是如何对 JVM 进行优化的？/Ciqc1F6qeiKAYxCiAAA-QtFxAzw826.png)
...
![图片1.png](images/未学-第12讲：DVM 以及 ART 是如何对 JVM 进行优化的？/Ciqc1F6qe4eAZ1zLAAB2Q6lEkoE595.png)
...
![图片2.png](images/未学-第12讲：DVM 以及 ART 是如何对 JVM 进行优化的？/CgqCHl6qe9WAY-x4AAHlcF3z4X8795.png)
...
![图片3.png](images/未学-第12讲：DVM 以及 ART 是如何对 JVM 进行优化的？/CgqCHl6qe-aATBEFAAEFkKPCQb4077.png)
